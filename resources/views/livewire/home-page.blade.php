<div>
  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
      <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-rose-950">Glowies</span></h1>
      <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varities of Glowies categories like Makeup, Skin Care and many more.</p>
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Explore trusted brands offering quality skincare, beauty, and lifestyle products to enhance your routine.
      </p>
    </div>
  </div>
      ...
      @foreach ($brands as $brand)
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
          <a href="/products?selected_brands[0]={{ $brand->id }}" class="">
            <img src="{{ Storage::disk('s3')->url($brand->image) }}" alt="{{ $brand->name }}" class="object-cover w-full h-64 rounded-t-lg">
          </a>
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Browse top categories for skincare, beauty, fashion, and lifestyle products tailored to your needs.
      </p>
    </div>
  </div>
          ...
          <div class="p-4 md:p-5">
            <div class="flex justify-between items-center">
              <div class="flex items-center">
                <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ Storage::disk('s3')->url($category->image) }}" alt="{{ $category->name }}">
                <div class="ms-3">
